...
def test_get_mask_card_number_no_number_1(no_number_1, no_number_2, no_number_3, no_number_4):
...
def test_get_mask_account_no_number(no_number_1, no_number_2, no_number_3, no_number_4):
